...
`},Oe=c,ke=l,Ae=u,je={root:{background:`{gray.0}`,borderColor:`{gray.500}`,color:`{gray.500}`,borderRadius:`{content.border.radius}`,shadow:`{elevation.$light.bottom.40}`},list:{padding:`0 0 0.25rem`,gap:`0`},item:{focusBackground:`{gray.50}`,activeBackground:`{gray.50}`,color:`{gray.700}`,focusColor:`{gray.900}`,activeColor:`{gray.900}`,padding:`0.75rem 1rem`,borderRadius:`0`,gap:`0.5rem`,icon:{color:`{gray.700}`,focusColor:`{gray.900}`,activeColor:`{gray.900}`}},submenuIcon:{size:`1rem`,color:`{gray.500}`,focusColor:`{gray.900}`,activeColor:`{gray.900}`},separator:{borderColor:`{gray.500}`},css:({dt:e})=>`
...
`},Me=d,Ne=f,Pe=p,Fe=m,Ie=h,Le=g,Re=_,ze=v,Be=y,Ve=b,He={root:{fontWeight:`300`,active:{fontSize:`0.625rem`,fontWeight:`300`}},in:{input:{paddingTop:`calc(1.125rem - 0.5px)`,paddingBottom:`0.375rem`},active:{top:`calc(0.375rem - 0.5px)`}}},Ue=x,We=S,Ge={root:{top:`calc(0.375rem - 0.5px)`,fontSize:`0.625rem`,fontWeight:`300`},input:{paddingTop:`calc(1.125rem - 0.5px)`,paddingBottom:`0.375rem`}},Ke=C,qe=w,Je=T,Ye=E,Xe=D,Ze=O,Qe=k,$e=A,et={css:({dt:e})=>`
...
`},tt=j,nt=M,rt=N,it={root:{background:`{gray.0}`,borderColor:`{gray.500}`,color:`{gray.500}`,borderRadius:`{content.border.radius}`,shadow:`{elevation.$light.bottom.40}`},list:{padding:`0 0 0.25rem`,gap:`0`},item:{focusBackground:`{gray.50}`,color:`{gray.700}`,focusColor:`{gray.900}`,padding:`0.75rem 1rem`,borderRadius:`0`,gap:`0.5rem`,icon:{color:`{gray.700}`,focusColor:`{gray.900}`}},submenuLabel:{padding:`0.75rem 1rem 0.5rem`,fontWeight:`500`,background:`{gray.0}`,color:`{gray.900}`},separator:{borderColor:`{gray.500}`},css:({dt:e})=>`
...
`},lt=I,ut=L,dt=R,ft=z,pt=B,mt=V,ht=H,gt=U,_t=W,vt=G,yt={colorScheme:{light:{root:{colorOne:`{primary.500}`,colorTwo:`{primary.500}`,colorThree:`{primary.500}`,colorFour:`{primary.500}`}},dark:{root:{colorOne:`{primary.400}`,colorTwo:`{primary.400}`,colorThree:`{primary.400}`,colorFour:`{primary.400}`}}}},bt={root:{hoverBorderColor:`{input.hoverBorderColor}`,checkedBackground:`{input.checked.background}`,checkedHoverBackground:`{input.checked.hover.background}`,checkedBorderColor:`{input.checked.border.color}`,checkedHoverBorderColor:`{input.checked.hover.border.color}`,checkedFocusBorderColor:`{input.checked.focus.border.color}`},icon:{size:`0.75rem`,sm:{size:`0.5rem`},lg:{size:`1rem`}}},xt=K,St=q,Ct=J,wt={css:({dt:e})=>`
 .p-select-option[aria-selected="true"], .p-select-option[aria-selected="true"] > .p-select-option-check-icon {
 color:${e(`list.option.selectedColor`)};
`},Tt=Y,Et=X,Dt=Z,Ot=Q,kt=$,At=ee,jt=te,Mt=ne,Nt=re,Pt=ie,Ft=ae,It={root:{fontWeight:`400`},colorScheme:{light:{primary:{background:`{blue.300}`,color:`{text.color}`},secondary:{background:`{surface.200}`,color:`{text.color}`},success:{background:`{green.300}`,color:`{text.color}`},info:{background:`{cyan.300}`,color:`{text.color}`},warn:{background:`{orange.300}`,color:`{text.color}`},danger:{background:`{red.300}`,color:`{text.color}`},contrast:{background:`{purple.300}`,color:`{text.color}`}},dark:{primary:{background:`{blue.300}`,color:`{text.color}`},secondary:{background:`{surface.200}`,color:`{text.color}`},success:{background:`{green.300}`,color:`{text.color}`},info:{background:`{cyan.300}`,color:`{text.color}`},warn:{background:`{orange.300}`,color:`{text.color}`},danger:{background:`{red.300}`,color:`{text.color}`},contrast:{background:`{purple.300}`,color:`{text.color}`}}},css:`
  .p-tag {
    line-height: 1rem;
  }
`},Lt=oe,Rt=se,zt={root:{background:`{gray.0}`,borderColor:`{gray.500}`,color:`{gray.500}`,borderRadius:`{content.border.radius}`,shadow:`{elevation.$light.bottom.40}`},list:{padding:`0 0 0.25rem`,gap:`0`},item:{focusBackground:`{gray.50}`,activeBackground:`{gray.50}`,color:`{gray.700}`,focusColor:`{gray.900}`,activeColor:`{gray.900}`,padding:`0.75rem 1rem`,borderRadius:`0`,gap:`0.5rem`,icon:{color:`{gray.700}`,focusColor:`{gray.900}`,activeColor:`{gray.900}`}},submenu:{mobileIndent:`1.25rem`},submenuIcon:{size:`1rem`,color:`{gray.500}`,focusColor:`{gray.900}`,activeColor:`{gray.900}`},separator:{borderColor:`{gray.500}`},css:({dt:e})=>`
.p-contextmenu-submenu-label {
  border-bottom: 1px solid ${e(`{gray.500}`)};
  margin-bottom: 5px;
}
