...
`},at=F,ot=I,st=L,ct={root:{padding:`0`,gap:`0.25rem`,borderRadius:`0`,background:`transparent`,color:`{gray.800}`},navButton:{background:`transparent`,hoverBackground:`{gray.200}`,selectedBackground:`{gray.200}`,color:`{gray.800}`,hoverColor:`{gray.900}`,selectedColor:`{gray.900}`,width:`2.5rem`,height:`2.5rem`,borderRadius:`50%`},css:({dt:e})=>`
  .p-paginator-pages{
   margin: 0 1rem;
  }
  .p-paginator-pages,
...
`},lt=R,ut=z,dt=B,ft=V,pt=H,mt={root:{height:`0.5rem`},value:{background:`repeating-linear-gradient(45deg, {primary-color} 0, {primary-color} 0.5rem, color-mix(in srgb, {primary-color} 72%, white 28%) 0.5rem, color-mix(in srgb, {primary-color} 72%, white 28%) 1rem)`},label:{color:`transparent`}},ht={colorScheme:{light:{root:{colorOne:`{primary.500}`,colorTwo:`{primary.500}`,colorThree:`{primary.500}`,colorFour:`{primary.500}`}},dark:{root:{colorOne:`{primary.400}`,colorTwo:`{primary.400}`,colorThree:`{primary.400}`,colorFour:`{primary.400}`}}}},gt={root:{hoverBorderColor:`{input.hoverBorderColor}`,checkedBackground:`{input.checked.background}`,checkedHoverBackground:`{input.checked.hover.background}`,checkedBorderColor:`{input.checked.border.color}`,checkedHoverBorderColor:`{input.checked.hover.border.color}`,checkedFocusBorderColor:`{input.checked.focus.border.color}`},icon:{size:`0.75rem`,sm:{size:`0.5rem`},lg:{size:`1rem`}}},_t=U,vt=W,yt=G,bt={css:({dt:e})=>`
 .p-select-option[aria-selected="true"], .p-select-option[aria-selected="true"] > .p-select-option-check-icon {
 color:${e(`list.option.selectedColor`)};
`},xt={root:{borderRadius:`8rem`},css:({dt:e})=>`
  .p-selectbutton{
...
`},St=K,Ct=q,wt=J,Tt=Y,Et=X,Dt=Z,Ot=Q,kt=$,At=ee,jt=te,Mt={root:{fontWeight:`400`},colorScheme:{light:{primary:{background:`{blue.300}`,color:`{text.color}`},secondary:{background:`{surface.200}`,color:`{text.color}`},success:{background:`{green.300}`,color:`{text.color}`},info:{background:`{cyan.300}`,color:`{text.color}`},warn:{background:`{orange.300}`,color:`{text.color}`},danger:{background:`{red.300}`,color:`{text.color}`},contrast:{background:`{purple.300}`,color:`{text.color}`}},dark:{primary:{background:`{blue.300}`,color:`{text.color}`},secondary:{background:`{surface.200}`,color:`{text.color}`},success:{background:`{green.300}`,color:`{text.color}`},info:{background:`{cyan.300}`,color:`{text.color}`},warn:{background:`{orange.300}`,color:`{text.color}`},danger:{background:`{red.300}`,color:`{text.color}`},contrast:{background:`{purple.300}`,color:`{text.color}`}}},css:`
  .p-tag {
    line-height: 1rem;
  }
`},Nt=ne,Pt=re,Ft={root:{background:`{context.menu.background}`,borderColor:`{context.menu.border.color}`,color:`{context.menu.color}`,borderRadius:`{context.menu.border.radius}`,shadow:`{context.menu.shadow}`},list:{padding:`{context.menu.list.padding}`,gap:`{context.menu.list.gap}`},item:{focusBackground:`{context.menu.item.focus.background}`,activeBackground:`{context.menu.item.focus.background}`,color:`{context.menu.item.color}`,focusColor:`{context.menu.item.focus.color}`,activeColor:`{context.menu.item.focus.color}`,padding:`{context.menu.item.padding}`,borderRadius:`{context.menu.item.border.radius}`,gap:`{context.menu.item.gap}`,icon:{color:`{context.menu.item.icon.color}`,focusColor:`{context.menu.item.icon.focus.color}`,activeColor:`{context.menu.item.icon.focus.color}`}},submenuIcon:{size:`1rem`,color:`{context.menu.item.icon.color}`,focusColor:`{context.menu.item.icon.focus.color}`,activeColor:`{context.menu.item.icon.focus.color}`},separator:{borderColor:`{context.menu.separator.border.color}`},css:({dt:e})=>`
