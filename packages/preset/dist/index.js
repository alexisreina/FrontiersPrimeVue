...
`},Ae=d,je=f,Me=p,Ne=m,Pe=h,Fe=g,Ie=_,Le=v,Re=y,ze={root:{fontWeight:`300`,active:{fontSize:`0.625rem`,fontWeight:`300`}},in:{input:{paddingTop:`calc(1.125rem - 0.5px)`,paddingBottom:`0.375rem`},active:{top:`calc(0.375rem - 0.5px)`}}},Be=b,Ve=x,He={root:{top:`calc(0.375rem - 0.5px)`,fontSize:`0.625rem`,fontWeight:`300`},input:{paddingTop:`calc(1.125rem - 0.5px)`,paddingBottom:`0.375rem`}},Ue=S,We=C,Ge=w,Ke=T,qe=E,Je=D,Ye=O,Xe=k,Ze={css:({dt:e})=>`
...
`},ot=F,st=I,ct=L,lt={root:{padding:`0`,gap:`0.25rem`,borderRadius:`0`,background:`transparent`,color:`{gray.800}`},navButton:{background:`transparent`,hoverBackground:`{gray.200}`,selectedBackground:`{gray.200}`,color:`{gray.800}`,hoverColor:`{gray.900}`,selectedColor:`{gray.900}`,width:`2.5rem`,height:`2.5rem`,borderRadius:`50%`},css:({dt:e})=>`
  .p-paginator-pages{
   margin: 0 1rem;
  }
  .p-paginator-pages,
