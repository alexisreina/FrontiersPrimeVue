...
const semantic: LaraBaseTokenSections.Semantic & SemanticExtensions = {
  ...
  overlay: {
    ...
    modal: {
      borderRadius: "{border.radius.lg}",
      padding: "1.5rem",
      shadow: "{elevation.$light.bottom.50}",
    },
  },
  list: {
    option: {
  ...
  contextMenu: {
    ...
    listGap: "0",
    itemFocusBackground: "{surface.50}",
    itemColor: "{surface.700}",
    itemFocusColor: "{surface.900}",
    itemPadding: "0.75rem 1rem",
    itemBorderRadius: "0",
    itemGap: "0.5rem",
    itemIconColor: "{surface.700}",
    itemIconFocusColor: "{surface.900}",
    itemIconActiveColor: "{surface.900}",
    submenuLabelPadding: "0.75rem 1rem 0.5rem",
    submenuLabelFontWeight: "500",
    submenuLabelBackground: "{surface.0}",
    submenuLabelColor: "{surface.900}",
    submenuLabelBorderBottom: "1px solid {surface.500}",
    submenuLabelMarginBottom: "5px",
    separatorBorderColor: "{surface.500}",
